...
#----Ben Momo -----
# python manage.py inspectdb  > models_20160511.py
...
class Chart(models.Model):
    ...
    def __str__(self):
        return  str(self.chart_no) + " " + self.pt_name
...
class Reg(models.Model):
    ...
    prenatal_care = models.CharField(db_column='PRENATAL_CARE', blank=True, max_length=1)
...
class BeaconInfo(models.Model):
    ...
    def __str__(self):
        return self.location_code + " " + self.uuid
...
class Medicine(models.Model):
    ...
    image_name = models.CharField(db_column='IMAGE_NAME', max_length=30)   # Field name made lowercase.
...
class PatientStatus(models.Model):
    ...
    def __str__(self):
        return  self.view_date + " - " +  str(self.chart_no) + " " + self.location_code
...
class PatientServicelist(models.Model):
    ...
    view_date = models.CharField(db_column='VIEW_DATE', max_length=7)  # Field name made lowercase.
    apn = models.IntegerField(db_column='APN', blank=True, null=True)
    seq_no = models.IntegerField(db_column='SEQ_NO', blank=True, null=True)  # Field name made lowercase.
    chart_no = models.IntegerField(db_column='CHART_NO', blank=True, null=True)  # Field name made lowercase.
